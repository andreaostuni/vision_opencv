...
ROSCvMatContainer::ROSCvMatContainer(std::unique_ptr<sensor_msgs::msg::Image> unique_sensor_msgs_image)
  : header_(NotNull(unique_sensor_msgs_image.get(), "unique_sensor_msgs_image cannot be nullptr").pointer->header)
  , frame_(unique_sensor_msgs_image->height, unique_sensor_msgs_image->width,
...
ROSCvMatContainer::ROSCvMatContainer(std::shared_ptr<sensor_msgs::msg::Image> shared_sensor_msgs_image)
  : header_(shared_sensor_msgs_image->header)
  , frame_(shared_sensor_msgs_image->height, shared_sensor_msgs_image->width,
...
ROSCvMatContainer::ROSCvMatContainer(const cv::Mat& mat_frame, const std_msgs::msg::Header& header, bool is_bigendian,
...
ROSCvMatContainer::ROSCvMatContainer(cv::Mat&& mat_frame, const std_msgs::msg::Header& header, bool is_bigendian,
                                     std::optional<std::string> encoding_override)
  : header_(header)
...
std::shared_ptr<const sensor_msgs::msg::Image> ROSCvMatContainer::get_sensor_msgs_msg_image_pointer() const
{
...
std::unique_ptr<sensor_msgs::msg::Image> ROSCvMatContainer::get_sensor_msgs_msg_image_pointer_copy() const
{
...
void ROSCvMatContainer::get_sensor_msgs_msg_image_copy(sensor_msgs::msg::Image& sensor_msgs_image) const
{
...
RCLCPP_USING_CUSTOM_TYPE_AS_ROS_MESSAGE_TYPE(cv_bridge::ROSCvMatContainer, sensor_msgs::msg::Image);